...
import io.github.edward3h.townnames.BuildResult;
import io.github.edward3h.townnames.TownNameGenerator;
...
class BuiltinSetTest {
  ...
  void withBuiltinIntegratesWithTownNameGenerator() {
    BuildResult result =
        TownNameGenerator.builder().withBuiltin(BuiltinSet.ENGLISH_ORIGINAL).withSeed(1L).build();
