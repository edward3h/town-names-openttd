package red.ethel.townnames.engine;
...
import red.ethel.townnames.grf.GrfData;
import red.ethel.townnames.grf.NameEntry;
import red.ethel.townnames.grf.NamePart;
...
class NameGenerationEngineTest {
    ...
    private static GrfData twoPartGrf() {
        ...
        // Part 1: "field" (100)
        var part0 = new NamePart(List.of(new NameEntry.Text(50, "North"), new NameEntry.Text(50, "South")));
