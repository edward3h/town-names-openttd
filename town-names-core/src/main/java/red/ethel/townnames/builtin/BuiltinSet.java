...
import red.ethel.townnames.builtin.data.AustrianData;
import red.ethel.townnames.builtin.data.CatalanData;
import red.ethel.townnames.builtin.data.CzechData;
import red.ethel.townnames.builtin.data.DanishData;
import red.ethel.townnames.builtin.data.DutchData;
import red.ethel.townnames.builtin.data.EnglishAdditionalData;
import red.ethel.townnames.builtin.data.EnglishOriginalData;
import red.ethel.townnames.builtin.data.FinnishData;
import red.ethel.townnames.builtin.data.FrenchData;
import red.ethel.townnames.builtin.data.GermanData;
import red.ethel.townnames.builtin.data.HungarianData;
import red.ethel.townnames.builtin.data.ItalianData;
import red.ethel.townnames.builtin.data.NorwegianData;
import red.ethel.townnames.builtin.data.PolishData;
import red.ethel.townnames.builtin.data.RomanianData;
import red.ethel.townnames.builtin.data.SillyData;
import red.ethel.townnames.builtin.data.SlovakData;
import red.ethel.townnames.builtin.data.SpanishData;
import red.ethel.townnames.builtin.data.SwedishData;
import red.ethel.townnames.builtin.data.SwissData;
import red.ethel.townnames.builtin.data.TurkishData;
import red.ethel.townnames.engine.NameSource;
...
public enum BuiltinSet implements NameSource {
    ...
    ENGLISH_ADDITIONAL {
        ...
        public String generate(Random rng) {
            ...
            if (rng.nextInt(20) >= 14) {
                ...
                if (rng.nextInt(20) >= 4) {
                    sb.append(EnglishAdditionalData.PART1B3A[rng.nextInt(EnglishAdditionalData.PART1B3A.length)]);
                } else {
                    sb.append(EnglishAdditionalData.PART1B3B[rng.nextInt(EnglishAdditionalData.PART1B3B.length)]);
                }
            }
    ...
    POLISH {
        @Override
        public String generate(Random rng) {
            int totalStems = PolishData.REAL.length
            ...
            if (i < PolishData.STEM_M.length + PolishData.REAL.length) {
                ...
                if (j >= 4 && j < 16) sb.append(PolishData.SUFFIX_M[rng.nextInt(PolishData.SUFFIX_M.length)]);
                return sb.toString();
            }
            ...
            if (i < PolishData.STEM_F.length + PolishData.STEM_M.length + PolishData.REAL.length) {
                ...
                if (j >= 4 && j < 16) sb.append(PolishData.SUFFIX_F[rng.nextInt(PolishData.SUFFIX_F.length)]);
                return sb.toString();
            }
    ...
    CZECH {
        ...
        public String generate(Random rng) {
            ...
            if (stem < CzechData.SUBST_FULL.length) {
                ...
                String postfix =
                        postfixChoice < CzechData.SUBST_POSTFIX.length ? CzechData.SUBST_POSTFIX[postfixChoice] : "";
